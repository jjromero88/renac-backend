...
namespace PCM.RENAC.Application.Control.Util
{
    public static class Constantes
    {
        public static string Aplicacion = "SISTEMA RENAC";
    }
    public static class ConstantesToken
    {
        public static string Key = "TokenClave";
        public static string Minutes = "TokenMinutos";
        public static string ExpiradoCodigoJWT = "IDX10230";
    }
    ...
    public static class TransactionMessage
    {
        ...
        public const string GenericErrorMessage = "Ocurrio un error durante el proceso.";
    }
    public static class AuthenticationMessage
    {
        public const string SuccessAuthenticate = "Autenticación Exitosa";
        public const string UserNoExists = "Usuario no existe";
        public static string DefaultUserId = "0";
        public static string DefaultUserName = "sys";
    }
    public static class FilesName
    {
        public static string InformeSsiat = "INFORMESSIAT";
        public static string DocumentoMemoSsiat = "MEMOSSIAT";
        public static string InformeOpinionFavorable = "INFORMEOPINIONFAVORABLE";
        public static string DocumentoMemoSsatdot = "MEMOSSATDOT";
        public static string EvidenciaAnotacion = "EVIDENCIAANOTACION";
        public static string EvidenciaSolicitudInformacion = "EVIDENCIASOLICITUDINFORMACION";
        public static string OficioAnotacion = "OFICIOANOTACION";
        public static string OficioSolicitudInformacion = "OFICIOSOLICITUDINFORMACION";
        public static string ConstanciaAnotacionRenac = "CONSTANCIAANOTACIONRENAC";
        public static string ConstanciaAnotacionFirmadaRenac = "CONSTANCIAANOTACION[F]";
        public static string RespuestaGore = "RESPUESTAGORE";
        public static string documentoAnotacion = "DOCUMENTOANOTACION";
    }
    public static class TipoAsientoCodigo
    {
        public static int Modificacion = 1;
        public static int Creacion = 2;
        public static int Cancelacion = 3;
    }
    public static class TipoCircunscripcionDescripcion
    {
