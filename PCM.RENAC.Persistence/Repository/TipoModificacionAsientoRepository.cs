...
{
    public class TipoModificacionAsientoRepository : ITipoModificacionAsientoRepository
    {
        private readonly DapperContext _context;
        private const string _schema = "renac";

        public TipoModificacionAsientoRepository(DapperContext context)
        {
            _context = context;
        }

        public Response Insert(TipoModificacionAsiento entidad)
        {
            ...
            try
            {
                ...
                {
                    var query = $"{_schema}.usp_tipo_modificacion_asiento_insertar";
        ...
        public Response Update(TipoModificacionAsiento entidad)
        {
            Response retorno = new Response();
            ...
            try
            {
                using (var connection = _context.CreateConnection())
                {
                    var query = $"{_schema}.usp_tipo_modificacion_asiento_actualizar";
        ...
        public Response Delete(TipoModificacionAsiento entidad)
        {
            Response retorno = new Response();
            ...
            try
            {
                using (var connection = _context.CreateConnection())
                {
                    var query = $"{_schema}.usp_tipo_modificacion_asiento_eliminar";
        ...
        public Response<dynamic> GetById(TipoModificacionAsiento entidad)
        {
            ...
            try
            {
                using (var sqlConnection = new NpgsqlConnection(connection.ConnectionString))
                {
                    ...
                    var result = sqlConnection.QuerySingle<TipoModificacionAsiento>($"SELECT * FROM {_schema}.fn_tipo_modificacion_asiento_seleccionar({entidad.idTipoModificacionAsiento})");
        ...
        public Response<List<dynamic>> GetList(TipoModificacionAsiento entidad)
        {
            ...
            try
            {
                using (var sqlConnection = new NpgsqlConnection(connection.ConnectionString))
                {
                    ...
                    {
                        var command = new NpgsqlCommand($"{_schema}.usp_tipo_modificacion_asiento_seleccionar", sqlConnection);
        ...
        public Response<List<dynamic>> GetListPaginated(TipoModificacionAsiento entidad, out int PageSize, out int PageNumber, out int TotalReg)
        {
            Response<List<dynamic>> retorno = new Response<List<dynamic>>();
            int _PageSize = 0;
            int _PageNumber = 0;
            ...
            try
            {
                ...
                using (var sqlConnection = new NpgsqlConnection(connection.ConnectionString))
                {
                    ...
                    using (var tran = sqlConnection.BeginTransaction())
                    {
                        var command = new NpgsqlCommand($"{_schema}.usp_tipo_modificacion_asiento_paginado", sqlConnection);
                        command.CommandType = CommandType.StoredProcedure;
